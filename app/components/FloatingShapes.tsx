...
// This component creates beautiful floating shapes that move around in the background
// The shapes have smooth animations and respond when you hover over them
export default function FloatingShapes() {
  ...
  const largeShapes = [
    {
      size: 200,
      initialX: 10,   // Top left area - moves across top-left quadrant
      initialY: 10,
      duration: 25,
      delay: 0,
      xRange: [5, 40],   // Moves from 5% to 40% horizontally
      yRange: [5, 35],   // Moves from 5% to 35% vertically
      gradient: isDark
    ...
    {
      size: 150,
      initialX: 90,  // Top right area - moves across top-right quadrant
      initialY: 15,
      duration: 30,
      delay: 4,
      xRange: [60, 95],   // Moves from 60% to 95% horizontally
      yRange: [5, 40],    // Moves from 5% to 40% vertically
      gradient: isDark
    ...
    {
      size: 180,
      initialX: 10,  // Bottom left area - moves across bottom-left quadrant
      initialY: 70,
      duration: 28,
      delay: 2,
      xRange: [5, 45],    // Moves from 5% to 45% horizontally
      yRange: [60, 95],   // Moves from 60% to 95% vertically
      gradient: isDark
    ...
    {
      size: 120,
      initialX: 80,  // Bottom right area - moves across bottom-right quadrant
      initialY: 75,
      duration: 32,
      delay: 5,
      xRange: [55, 95],   // Moves from 55% to 95% horizontally
      yRange: [60, 95],   // Moves from 60% to 95% vertically
      gradient: isDark
    ...
    {
      size: 100,
      initialX: 50,  // Center area - moves across center region
      initialY: 50,
      duration: 22,
      delay: 1,
      xRange: [30, 70],   // Moves from 30% to 70% horizontally
      yRange: [30, 70],   // Moves from 30% to 70% vertically
      gradient: isDark
  ...
  return (
    ...
    >
      ...
      {/* These are smaller shapes that add more visual interest - spread across different areas */}
      {[...Array(8)].map((_, index) => {
        const positions = [
          { x: 12, y: 12 },   // Top left corner
          { x: 88, y: 18 },   // Top right corner
          { x: 18, y: 78 },   // Bottom left corner
          { x: 82, y: 88 },   // Bottom right corner
          { x: 42, y: 8 },    // Top center-left
          { x: 58, y: 92 },   // Bottom center-right
          { x: 8, y: 48 },    // Middle left edge
          { x: 92, y: 52 },   // Middle right edge
        ];
        ...
        return (
          <motion.div
            ...
            animate={{
              ...
              rotate: index % 3 === 0 ? [0, 180, 360] : index % 3 === 1 ? [360, 180, 0] : [0, 270, 180, 360],
              opacity: isDark
                ? [0.2, 0.35, 0.28, 0.2]
                : [0.25, 0.4, 0.3, 0.25],
            }}
            transition={{
              ...
              repeat: Infinity,
              ease: 'easeInOut',
              delay: index * 0.8 + (index % 2) * 1.2, // More varied delays
            }}
            whileHover={{
              scale: 1.5,
      ...
      {/* Geometric shapes: rectangles, squares, and circles that move around */}
      {[...Array(12)].map((_, index) => {
        ...
        const positions = [
          { x: 5, y: 10, xRange: [0, 30], yRange: [0, 30] },      // Top left quadrant
          { x: 25, y: 5, xRange: [15, 45], yRange: [0, 25] },     // Top left-center
          { x: 45, y: 15, xRange: [35, 65], yRange: [0, 30] },   // Top center
          { x: 65, y: 8, xRange: [55, 85], yRange: [0, 25] },    // Top right-center
          { x: 85, y: 12, xRange: [70, 100], yRange: [0, 30] }, // Top right quadrant
          { x: 95, y: 20, xRange: [80, 100], yRange: [10, 40] }, // Top far right
          { x: 8, y: 40, xRange: [0, 35], yRange: [25, 55] },    // Middle left
          { x: 30, y: 45, xRange: [15, 50], yRange: [30, 60] },  // Middle left-center
          { x: 70, y: 50, xRange: [50, 85], yRange: [35, 65] },  // Middle right-center
          { x: 92, y: 55, xRange: [75, 100], yRange: [40, 70] }, // Middle right
          { x: 15, y: 75, xRange: [0, 40], yRange: [60, 100] },  // Bottom left quadrant
          { x: 50, y: 85, xRange: [35, 65], yRange: [70, 100] }, // Bottom center
        ];
